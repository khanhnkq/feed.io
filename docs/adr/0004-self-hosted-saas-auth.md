...
- Email verification is mandatory. Consuming a verification token activates the user and creates their organization plus owner membership in one database transaction.
