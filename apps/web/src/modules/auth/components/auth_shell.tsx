  ...
  return (
    ...
    >
      <section className="relative hidden min-h-screen flex-col justify-between overflow-hidden bg-ink px-[clamp(40px,6vw,96px)] py-12 text-[#f7f8ef] after:pointer-events-none after:absolute after:-bottom-[15vw] after:-right-[4vw] after:text-[min(62vw,760px)] after:font-black after:leading-[.72] after:tracking-[-.12em] after:text-[#22251e] after:content-['F'] lg:flex">
        <Link
          className="relative z-10 flex items-center gap-3 text-xl font-extrabold tracking-[-.04em]"
          href="/login"
        >
        ...
        <div className="relative z-10 max-w-[760px] py-20">
          ...
          <div className="mt-10 flex flex-wrap gap-5 text-xs text-[#aeb1a6]">
            <span className="flex items-center gap-2">
              <Check size={15} className="text-lime" /> Frame-accurate review
            </span>
            <span className="flex items-center gap-2">
              <Sparkles size={15} className="text-lime" /> Real-time team collaboration
            </span>
            <span className="flex items-center gap-2">
              <ShieldCheck size={15} className="text-lime" /> Secure asset management
            </span>
          </div>
        </div>
        <p className="relative z-10 text-xs text-[#777b70]">
          Built for creative agencies, post-production teams and studios.
        </p>
      </section>
      ...
      <section className="grid min-h-screen place-items-center content-center px-5 py-10 sm:px-10 lg:px-12">
        <div className="w-full max-w-[460px]">
          <Link
            className="mb-10 flex items-center gap-3 text-xl font-extrabold tracking-[-.04em] lg:hidden"
            href="/login"
          >
          ...
          {footer ? (
            <div className="mt-7 text-center text-xs leading-relaxed text-muted">
              {footer}
            </div>
          ) : null}
        </div>
